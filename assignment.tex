...
\begin{tabular}{rl}
\textbf{Name:}      & Mohamed \rule{6cm}{0.4pt} \\[6pt]
\textbf{Student ID:}& \rule{6cm}{0.4pt} \\[6pt]
\textbf{Course:}    & \rule{6cm}{0.4pt} \\[6pt]
\textbf{Instructor:}& \rule{6cm}{0.4pt} \\[6pt]
\textbf{Date:}      & \today
\end{tabular}

\vfill
{\large GitHub: \url{https://github.com/<your-username>/BTree-Assignment}\par}
\end{titlepage}
...
\url{https://github.com/<your-username>/BTree-Assignment}\\[6pt]
